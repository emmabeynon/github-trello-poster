...
describe 'Trello API' do
  ...
  it 'successfully returns a specified card' do
    expect(trello_poster_1.access_trello_card.url).to eq('https://trello.com/c/eciTsr8v/19-add-testfile-1-txt-to-project-a')
  end

  it 'checks if a checklist called "Pull Requests" is present' do
    trello_poster_1.access_trello_card
    trello_poster_1.check_for_pr_checklist
  ...
  it 'creates a checklist called "Pull Requests" if there is not one present' do
    ...
    expect(trello_poster_2.pr_checklist).to be nil

    trello_poster_2.check_for_pr_checklist
